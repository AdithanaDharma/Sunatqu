        ...
        <div class="fixed overflow-y-auto inset-0 bg-black/50 z-50 flex items-center justify-center">
            <div
                ...
                <div class="flex items-center justify-between  pb-4  rounded-t dark:border-gray-600 border-gray-200">
                    <h5 class="text-xl font-bold text-gray-900 dark:text-white">Detail Pendaftaran</h5>
                ...
                <form>
                    ...
                    <div class="grid gap-3 mb-2 md:grid-cols-2">
                        ...
                        <div>
                            <label for="Umur" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama
                                Orang tua</label>
                        ...
                        <div>
                            <label for="Berat Badan"
                                class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Berat Badan</label>
                        ...
                        <div>
                            <label for="visitors"
                                class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Paket</label>
                            <p type="number" id="visitors"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <span
                                    class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-gray-300">{{ $paket}}</span>
                            </p>
                        </div>
                        <div>
                            <label for="visitors"
